...
class ExpiryEditDialog extends StatefulWidget {
  ...
  const ExpiryEditDialog({super.key, required this.product});
...
class _ExpiryEditDialogState extends State<ExpiryEditDialog> {
  ...
  void initState() {
    super.initState();
    _expiryDate = widget.product.expiryDateValue;
  }
  ...
  void _submit() {
    ...
    Navigator.pop(context, _expiryDate!.toUtc().toIso8601String());
  }
