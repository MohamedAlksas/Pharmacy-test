...
class _DashboardPageState extends State<DashboardPage> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              _kpiCard(context, 'Total Materials',
                                  provider.totalProducts.toString(),
                                  icon: Icons.grid_view),
                              const SizedBox(width: 12),
                              _kpiCard(context, 'Nearing Expiry',
                                  ...
                                  color: expiringSoonCount > 0
                                      ...
                                      : null),
                              const SizedBox(width: 12),
                              _kpiCard(context, 'Low Stock Items',
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text('Recent Materials',
                                  style: TextStyle(
                                      fontWeight: FontWeight.w700)),
                              const SizedBox(height: 12),
                              ...provider.products.take(5).map((m) =>
                                  Column(children: [
                                    _activityRow(
                                      m.name,
                                      'In Stock',
  ...
  Widget _alertCard(BuildContext context, String title, String body,
  ...
  Widget _activityRow(
      String item, String type, String quantity, String date, String user) {
